...
//  }
  ...
  public ResponseEntity<String> addFarmer(@RequestBody Farmer fr)
  {
     try
     {
        String output = adminService.addFarmer(fr);
  ...
  public ResponseEntity<List<Farmer>> viewfarmers()
  {
	 List<Farmer> Fr =  adminService.displayFarmer();
	 
	 return ResponseEntity.ok(Fr); // 200 - success
  }
//  
